from Generator_Trainer import train_dungeon_generator, generate_dungeon_with_model, visualize_dungeon, export_dungeon

trained_agent, trained_envs = train_dungeon_generator(num_episodes=2000)
